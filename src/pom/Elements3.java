...
public class Elements3 {
	...
	public static WebElement creditcards(WebDriver driver,int row, int col){
		...
		WebElement ccdata=driver.findElement(By.xpath(".//*[@id='carLoanSrpTable']/tbody/tr[contains(@class,'srpTable___row__primary ') ]["+row+"]/td["+col+"]"));
		return ccdata;
...
public static WebElement creditcardsimage(WebDriver driver,int row, int col){
		...
		WebElement ccdata=driver.findElement(By.xpath("//*[@id='carLoanSrpTable']/tbody/tr[contains(@class,'srpTable___row__primary ') ]["+row+"]/td["+col+"]/a/img"));
		return ccdata;
	...
	public static WebElement viewdetails(WebDriver driver, int row){
		...
		WebElement vd=driver.findElement(By.xpath(".//*[@id='carLoanSrpTable']/tbody/tr[contains(@class,'srpTable___row__viewMoreDetails ') ]["+row+"]"));
		return vd;
	...
	public static WebElement moreinfo(WebDriver driver, int row){
		...
		//*[@id="carLoanSrpTable"]/tbody/tr[1]/td[8]/a[1]/button
		
		WebElement o=driver.findElement(By.xpath("//*[@id='carLoanSrpTable']/tbody/tr[contains(@class,'srpTable___row__primary ') ]["+row+"]/td[8]/a"));
		return o;
